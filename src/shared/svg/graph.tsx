export const GraphSvg = () =>
  <svg width="60px" height="60px" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      ...
      fill="#8d9cf4"/>
    <path d="M34,53.5a1.5,1.5,0,0,1-1.446-1.1l-12-44a1.5,1.5,0,1,1,2.894-.79l12,44A1.5,1.5,0,0,1,34,53.5Z"
          fill="#7bcdd1"/>
    ...
    <path d="M44,25.5A5.5,5.5,0,1,1,49.5,20,5.507,5.507,0,0,1,44,25.5Zm0-8A2.5,2.5,0,1,0,46.5,20,2.5,2.5,0,0,0,44,17.5Z"
          fill="#f28080"/>
  </svg>;
